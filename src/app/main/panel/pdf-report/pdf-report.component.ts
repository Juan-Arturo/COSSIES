...
import { CommonModule } from '@angular/common'; // Importa CommonModule para habilitar *ngFor
...
export class PdfReportComponent {
  ...
  public generatePDF():void {
    ...
    const addLogo = ()=>{
      ...
      const logoUrl=  '../../assets/img/COSSIES_logo.png';
    ...
    logoImage.src='../../assets/img/COSSIES_logo.png';
    logoImage.onload = ()=>{
